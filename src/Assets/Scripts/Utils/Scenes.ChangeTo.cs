...
public partial class Scenes
{
    ...
    /// <summary>
    /// Schedules a scene change that will happen upon the publication of the <see cref="SceneLoadCompleteEvt"/> event.
    /// </summary>
    /// <remarks>Ensures that dependencies are loaded before loading the scene.</remarks>

...
public partial class I18nImpl
{
    ...
    private bool TryGetFromCache(string sectionKey, [NotNullWhen(returnValue: true)] out I18nSection? section)
    {
    ...
    private Result<I18nSection> ParseCsv(string csv, string sectionKey, string locale)
    {
        ...
        _logger.Info?.Log($"Loaded {section.LabelsCount()} labels from Resource csv: {sectionKey}@{locale}");
